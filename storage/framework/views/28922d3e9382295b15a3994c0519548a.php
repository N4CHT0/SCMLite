...
<?php $__env->startSection('sub-title','Tambah Stok'); ?>
<?php $__env->startSection('content'); ?>
        ...
        <form action="<?php echo e(route('stok.store')); ?>" method="POST" class="">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-group">
                ...
                <a href="<?php echo e(route('stok.index')); ?>" class="btn btn-secondary btn-block">Batal</a>
            </div>
            
        </form>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('template.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SISTEM-INFORMASI-SCM-I\SISCM\resources\views/stok/create.blade.php ENDPATH**/ ?>