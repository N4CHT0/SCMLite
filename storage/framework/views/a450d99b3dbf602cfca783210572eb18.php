          ...
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="<?php echo e(route('stok.index')); ?>">Cek Stok Barang</a></li>
                <li><a class="dropdown-item" href="<?php echo e(route('barang.index')); ?>">Cek Barang</a></li>
