...
<?php $__env->startSection('sub-title','Tambah Jadwal Pengiriman'); ?>
<?php $__env->startSection('content'); ?>

        <form action="/jadwal_pengiriman" method="POST" class="">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                  <input type="datetime-local" class="form-control" id="tanggal_pengiriman" name="tanggal_pengiriman" placeholder="Masukan Tanggal Pengiriman">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SISTEM-INFORMASI-SCM-I\SISCM\resources\views/jadwal_pengiriman/create.blade.php ENDPATH**/ ?>